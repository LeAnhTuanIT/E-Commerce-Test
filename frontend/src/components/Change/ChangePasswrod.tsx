    ...
    <div className="bg-gray-50 min-h-screen flex items-center justify-center dark:bg-gray-950">
      ...
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-7xl p-5 items-center">
        ...
        <div className="md:w-1/2 px-8 md:px-16">
          ...
          <form action="" method="post" className="flex flex-col gap-4 mt-4">
            {/* <input
            ...
            <div className="relative">
              <input
                className="p-2 rounded-xl border w-full dark:border-gray-500 dark:bg-gray-800 dark:text-white"
                type="password"
                name="password"
